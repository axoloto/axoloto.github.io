...
UI hierarchy and different levels of interactions, stronger one being at `PhysicsWidget` level
{:.figcaption}
...
Here is the final result in action, the new generic physics widget is very similar to the initial handmade one:
