...
description: >
  ...
  **Open source codebase can be found [here](https://github.com/axoloto/Boids).**
sitemap: false
...
**If you want to play with the boids or have a look at the code, everything is available [here](https://github.com/axoloto/Boids)**. Have fun!
